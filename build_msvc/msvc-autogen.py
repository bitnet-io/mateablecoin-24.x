...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Mateable Core {version}\""
...
def main():
    parser = argparse.ArgumentParser(description='Mateable-core msbuild configuration initialiser.')
    ...
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bitcoin_config.h'), os.path.join(SOURCE_DIR, 'config/mateable-config.h'))
