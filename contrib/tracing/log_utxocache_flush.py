...
"""Example logging Mateable Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/mateabled
...
def main(mateabled_path):
    ...
    b = BPF(text=program, usdt_contexts=[mateabled_with_usdts])
