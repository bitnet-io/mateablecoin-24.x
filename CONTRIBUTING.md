Contributing to Mateable Core
============================

The Mateable Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Mateable Core
...
Before you start contributing, familiarize yourself with the Mateable Core build
system and tests. Refer to the documentation in the repository on how to build
Mateable Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Mateable Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about Mateable Core development happens on IRC, in the
`#mateable-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#mateable-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/mateable-core-dev/](https://www.erisian.com.au/mateable-core-dev/)
and [https://gnusha.org/mateable-core-dev/](https://gnusha.org/mateable-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/mateable-dev)
...
For GUI-related issues or pull requests, the https://github.com/mateable-core/gui repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to mateable-qt
...
fork of Mateable Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Mateable Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Mateable
Network Protocol consensus changes.

Whether a pull request is merged into Mateable Core rests with the project merge
maintainers.
...
Patches that change Mateable consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mateable consensus, it must have been
...
https://github.com/mateable-core/mateable-maintainer-tools#backport).
