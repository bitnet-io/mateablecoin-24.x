...
This guide describes how to build mateabled, command-line utilities, and GUI on OpenBSD.
...
Clone the Mateable Core repository to a directory. All build scripts and commands will run from this directory.
``` bash
...
Mateable Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
