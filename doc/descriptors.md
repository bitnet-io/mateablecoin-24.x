# Support for Output Descriptors in Mateable Core

Since Mateable Core v0.17, there is support for Output Descriptors. This is a
...
on Mateable's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Mateable Core descriptor wallet to serve as your
...
existing Mateable Core wallets, a convenience function `combo` is
...
All RPCs in Mateable Core will include the checksum in their output. Only
