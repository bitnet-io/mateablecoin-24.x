...
Below are some notes on how to build Mateable Core for Windows.

The options known to work for building Mateable Core on Windows are:
...
Note that for WSL the Mateable Core source path MUST be somewhere in the default mount file system, for
