...
The Mateable Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Mateable Core requires the ZeroMQ API >= 4.0.0
...
during the *configure* step of building mateabled:
...
For instance:
    ...
    $ mateabled -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=ipc:///tmp/mateabled.tx.raw \
...
From the perspective of mateabled, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into mateabled directly. Furthermore, no information is
...
using. Mateabled appends an up-counting sequence number to each
