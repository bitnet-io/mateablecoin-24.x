Mateable version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Mateable/mateable-0.5.4/
...
http://gitorious.org/bitcoin/mateabled-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Mateable-Qt notifications under Growl 1.3.
Increase required age of Mateable-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMateable properly when installing Mateable-Qt over it. (Windows)
