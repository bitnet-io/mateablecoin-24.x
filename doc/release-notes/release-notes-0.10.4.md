Mateable Core version 0.10.4 is now available from:

  <https://bitcoin.org/bin/mateable-core-0.10.4/>
...
- #6953 `43c2789` Split mateable-tx into its own package
- #6953 `dfe0d4d` Include mateable-tx binary on Debian/Ubuntu
