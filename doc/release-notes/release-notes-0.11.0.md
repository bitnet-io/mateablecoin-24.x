Mateable Core version 0.11.0 is now available from:

  <https://bitcoin.org/bin/mateable-core-0.11.0/>
...
Block pruning allows Mateable Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Mateable Core will 
...
For an example script see [mateable-submittx](https://github.com/laanwj/mateable-submittx).
...
- #6269 `95aca44` gitian: Use the new mateable-detached-sigs git repo for OSX signatures
...
- #5729 `9c4a5a5` Allow unit changes for read-only MateableAmountField
...
- #5809 `46bfbe7` Add mateable-cli man page
...
- #5849 `41259ca` contrib/init/mateabled.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename Mateable-Qt.app to Mateable-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for mateable-tx)
