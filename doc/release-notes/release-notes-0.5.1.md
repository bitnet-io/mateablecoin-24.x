Mateable version 0.5.1 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Mateable/mateable-0.5.1/
...
Improved searching in addresses and labels in mateable-qt.
