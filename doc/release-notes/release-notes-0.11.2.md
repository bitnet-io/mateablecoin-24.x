Mateable Core version 0.11.2 is now available from:

  <https://bitcoin.org/bin/mateable-core-0.11.2/>
...
**Notice to miners:** Mateable Core’s block templates are now for
version 4 blocks only, and any mining software relying on its
getblocktemplate must be updated in parallel to use libblkmaker either
version 0.4.3 or any version from 0.5.2 onward.

- If you are solo mining, this will affect you the moment you upgrade
  Mateable Core, which must be done prior to BIP65 achieving its 951/1001
  status.
...
Mateable transactions currently may specify a locktime indicating when
...
entire blockchain after an unclean shutdown of Mateable Core on Windows
...
- #6600 `1e672ae` Debian/Ubuntu: Include mateable-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split mateable-tx into its own package
