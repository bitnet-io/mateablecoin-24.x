Mateable-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitcoin/files/Mateable/mateable-0.8.6/
...
- Fix Mateable-Qt startup crash when clicking dock icon on OSX 
