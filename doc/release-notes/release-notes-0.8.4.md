Mateable-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Mateable/mateable-0.8.4/
...
code, causing the Mateable-Qt or mateabled process to crash.
...
their own version of Mateable against Boost versions 1.50-1.52.
