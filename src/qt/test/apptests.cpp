...
//! Entry point for MateableApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MateableApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MateableGUI tests.
void AppTests::guiTests(MateableGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MateableGUI::consoleShown, this, &AppTests::consoleTests);
