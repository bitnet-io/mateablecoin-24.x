    ...
    mapper(nullptr)
{
    ...
    ui->openMateableConfButton->setToolTip(ui->openMateableConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MateableUnits(this));
...
void OptionsDialog::on_openMateableConfButton_clicked()
{
