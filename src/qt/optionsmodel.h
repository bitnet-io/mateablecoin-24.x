...
#ifndef MATEABLE_QT_OPTIONSMODEL_H
#define MATEABLE_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Mateable client.
...
public:
    ...
    MateableUnit getDisplayUnit() const { return m_display_bitcoin_unit; }
...
private:
    ...
    QString language;
    MateableUnit m_display_bitcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(MateableUnit unit);
    void coinControlFeaturesChanged(bool);
    void showTrayIconChanged(bool);
    void useEmbeddedMonospacedFontChanged(bool);
};

#endif // MATEABLE_QT_OPTIONSMODEL_H
