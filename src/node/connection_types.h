...
#ifndef MATEABLE_NODE_CONNECTION_TYPES_H
#define MATEABLE_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/mateable-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Mateable’s Peer-to-Peer Network")
...
#endif // MATEABLE_NODE_CONNECTION_TYPES_H
