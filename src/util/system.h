 ...
 */
#ifndef MATEABLE_UTIL_SYSTEM_H
#define MATEABLE_UTIL_SYSTEM_H
...
extern const char * const MATEABLE_CONF_FILENAME;
extern const char * const MATEABLE_SETTINGS_FILENAME;
