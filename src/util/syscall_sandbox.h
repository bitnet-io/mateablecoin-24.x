...
#ifndef MATEABLE_UTIL_SYSCALL_SANDBOX_H
#define MATEABLE_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during mateabled initialization if Mateable Core was compiled
...
#endif // MATEABLE_UTIL_SYSCALL_SANDBOX_H
