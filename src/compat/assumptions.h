...
#ifndef MATEABLE_COMPAT_ASSUMPTIONS_H
#define MATEABLE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Mateable cannot be compiled without assertions."
#endif
...
#endif // MATEABLE_COMPAT_ASSUMPTIONS_H
