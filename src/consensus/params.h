...
#ifndef MATEABLE_CONSENSUS_PARAMS_H
#define MATEABLE_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Mateable Script solution
...
#endif // MATEABLE_CONSENSUS_PARAMS_H
