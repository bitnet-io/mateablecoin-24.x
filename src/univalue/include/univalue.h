...
// Copyright 2015 Mateable Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef MATEABLE_UNIVALUE_INCLUDE_UNIVALUE_H
#define MATEABLE_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // MATEABLE_UNIVALUE_INCLUDE_UNIVALUE_H
