...
#ifndef MATEABLE_SCRIPT_STANDARD_H
#define MATEABLE_SCRIPT_STANDARD_H
...
/**
 * Generate a Mateable scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MATEABLE_SCRIPT_STANDARD_H
