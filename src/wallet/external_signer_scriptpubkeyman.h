...
#ifndef MATEABLE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MATEABLE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MATEABLE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
