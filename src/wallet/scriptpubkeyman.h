...
#ifndef MATEABLE_WALLET_SCRIPTPUBKEYMAN_H
#define MATEABLE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Mateable Core wallet was originally a collection of unrelated private
...
#endif // MATEABLE_WALLET_SCRIPTPUBKEYMAN_H
