...
#ifndef MATEABLE_PROTOCOL_H
#define MATEABLE_PROTOCOL_H
...
/**
 * Mateable protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Mateable Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Mateable Core nodes used to support this by default, without advertising this bit,
    ...
    // mateable-development mailing list. Remember that service bits are just
