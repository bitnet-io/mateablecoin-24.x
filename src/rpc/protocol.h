...
#ifndef MATEABLE_RPC_PROTOCOL_H
#define MATEABLE_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in mateabled
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Mateable is not connected
