// Copyright (c) 2019-2020 The Mateable Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MATEABLE_TEST_UTIL_TRANSACTION_UTILS_H
#define MATEABLE_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // MATEABLE_TEST_UTIL_TRANSACTION_UTILS_H
