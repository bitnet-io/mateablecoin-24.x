...
#ifndef MATEABLE_TEST_SCRIPTNUM10_H
#define MATEABLE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mateable Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MATEABLE_TEST_SCRIPTNUM10_H
