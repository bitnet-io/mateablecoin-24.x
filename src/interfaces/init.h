...
#ifndef MATEABLE_INTERFACES_INIT_H
#define MATEABLE_INTERFACES_INIT_H
...
//! (mateable-gui, mateable-node, mateable-wallet, mateabled, mateable-qt) and each
...
#endif // MATEABLE_INTERFACES_INIT_H
