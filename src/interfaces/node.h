...
#ifndef MATEABLE_INTERFACES_NODE_H
#define MATEABLE_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoin node (mateabled process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // MATEABLE_INTERFACES_NODE_H
