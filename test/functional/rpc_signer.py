...
Verify that a mateabled node can use an external signer command.
...
class RPCSignerTest(MateableTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart mateabled with -signer=<cmd>',
