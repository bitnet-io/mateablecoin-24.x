...
class TestShell:
    """Wrapper Class for MateableTestFramework.

    The TestShell class extends the MateableTestFramework
    ...
    class __TestShell(MateableTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MateableTestFramework child class.
            self.num_nodes = 1
