...
class TestMateableCli(MateableTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `mateable-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and mateable-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and mateable-cli getwalletinfo return expected wallet info")
            ...
            # Test mateable-cli -generate with -rpcwallet in multiwallet mode.
