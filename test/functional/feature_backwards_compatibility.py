...
class BackwardsCompatibilityTest(MateableTestFramework):
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes mateabled to exit, in addition to the RPC
        ...
        if self.options.descriptors:
            ...
            node_v17.assert_start_raises_init_error(["-wallet=w3"], "Error: Error loading w3: Wallet requires newer version of Mateable Core")
        ...
        if self.is_bdb_compiled():
            ...
            # Copy the 0.16 wallet to the last Mateable Core version and open it:
            shutil.copyfile(
            ...
            # Copy the 0.17 wallet to the last Mateable Core version and open it:
            ...
            # Copy the 0.19 wallet to the last Mateable Core version and open it:
            shutil.copytree(
