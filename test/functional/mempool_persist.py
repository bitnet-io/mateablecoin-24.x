...
By default, mateabled will dump mempool on shutdown and
...
class MempoolPersistTest(MateableTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent mateabled from writing mempool.dat to disk. Verify that `savemempool` fails")
