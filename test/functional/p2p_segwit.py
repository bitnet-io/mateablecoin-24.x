...
class SegWitTest(MateableTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older mateabled's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let mateabled fill it in.
