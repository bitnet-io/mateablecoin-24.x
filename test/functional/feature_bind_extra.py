...
"""
Test starting mateabled with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MateableTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that mateabled has bound on "::1" (for RPC) and "::" (for P2P).
