...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MateableTestFramework
    pass


class ExampleTest(MateableTestFramework):
    # Each functional test is a subclass of the MateableTestFramework class.
    ...
    def custom_method(self):
        ...
        MateableTestFramework class so other tests can use it."""
